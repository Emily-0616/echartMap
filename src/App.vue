...
const chartRef = ref()
const getGridLngLats = (center: any, colNum: any, size: any, cellX: any, cellY: any, map: any) => {
...
onMounted(async () => {
  await AMapLoader.load({
    key: 'b14ee71c8078e425a3dae28b94d6cc7f',
    version: '2.0',
    ...
    // // 获取 ECharts 高德地图组件
    // var amapComponent = chartRef.value.getModel().getComponent('amap')
  ...
  nextTick(() => {
    // 获取 ECharts 高德地图组件
    const amapComponent = chartRef.value.chart.getModel().getComponent('amap')
    // 获取高德地图实例，使用高德地图自带的控件
    ...
    window.AMapUI.load(['ui/geo/DistrictExplorer', 'lib/$'], (DistrictExplorer: any, $: any) => {
      //创建一个实例
      ...
      //根据Hover状态设置相关样式
      function toggleHoverFeature(feature: any, isHover: any, position: any) {
      ...
      //监听feature的hover事件
      districtExplorer.on('featureMouseout featureMouseover', function (e: any, feature: any) {
        toggleHoverFeature(
          feature,
      ...
      //feature被点击
      districtExplorer.on('featureClick', function (e: any, feature: any) {
        var props = feature.properties
        //如果存在子节点
      ...
      districtExplorer.on('outsideClick', function (e: any) {
        districtExplorer.locatePosition(
          ...
          function (error: any, routeFeatures: any) {
      ...
      //绘制区域面板的节点
      function renderAreaPanelNode(ele: any, props: any, color?: any) {
      ...
      function renderAreaPolygons(areaNode: any) {
        //更新地图视野
        amap.setBounds(areaNode.getBounds(), null, null, true)

        //清除已有的绘制内容
        districtExplorer.clearFeaturePolygons()

        //绘制子区域
        districtExplorer.renderSubFeatures(areaNode, function (feature: any, i: any) {
      ...
      //切换区域
      function switch2AreaNode(adcode: any, callback?: any) {
      ...
      //加载区域
      function loadAreaNode(adcode: any, callback: any) {
      ...
      $('#area-tree').on('mouseenter mouseleave', 'h2[data-adcode]', (e: any) => {
      ...
      $('#area-tree').on('click', 'h2', () => {
        var adcode = $(this).attr('data-adcode')
        switch2AreaNode(adcode)
      })

      $('#area-tree').on('click', '.showHideBtn', () => {
